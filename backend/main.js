           ...
           groqUrl,
            {
                ...
                // ✅ UPDATED: Changed from decommissioned llama3-8b-8192
                model: "llama-3.3-70b-versatile", 
                temperature: 0.1, // Set low for more consistent JSON output
                response_format: { type: "json_object" } // Tells Groq to strictly return JSON
            },
